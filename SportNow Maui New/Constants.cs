...
namespace SportNow
{
    public static class Constants
    {
        ...
        {
            { "9_Kyu", "9º Kyu" },
            { "8_Kyu_Kari", "9º/8º Kyu" },
            { "8_Kyu", "8º Kyu" },
            { "7_Kyu_Kari", "8º/7º Kyu" },
            { "7_Kyu", "7º Kyu" },
            { "6_Kyu_Kari", "7º/6º Kyu" },
            { "6_Kyu", "6º Kyu" },
            { "5_Kyu_Kari", "6º/5º Kyu" },
            { "5_Kyu", "5º Kyu" },
            { "4_Kyu_Kari", "5º/4º Kyu" },
            { "4_Kyu", "4º Kyu" },
            { "3_Kyu_Kari", "4º/3º Kyu" },
            { "3_Kyu", "3º Kyu" },
            { "2_Kyu", "2º Kyu" },
            { "1_Kyu", "1º Kyu" },
            { "1_Dan", "1º Dan" },
        ...
        public static List<Belt> belts { get; } = new List<Belt> {
            ...
            new Belt { gradecode = "8_Kyu_Kari", grade = "9º/8º Kyu", image = "belt_8_Kyu_Kari.png"  },
            new Belt { gradecode = "8_Kyu", grade = "8º Kyu", image = "belt_8_Kyu.png"  },
            new Belt { gradecode = "7_Kyu_Kari", grade = "8º/7º Kyu Kari", image = "belt_7_Kyu_Kari.png"  },
            new Belt { gradecode = "7_Kyu", grade = "7º Kyu", image = "belt_7_Kyu.png"  },
            new Belt { gradecode = "6_Kyu_Kari", grade = "7º/6º Kyu", image = "belt_6_Kyu_Kari.png"  },
            new Belt { gradecode = "6_Kyu", grade = "6º Kyu", image = "belt_7_Kyu.png"  },
            new Belt { gradecode = "5_Kyu_Kari", grade = "6º/5º Kyu", image = "belt_5_Kyu_Kari.png"  },
            new Belt { gradecode = "5_Kyu", grade = "5º Kyu", image = "belt_5_Kyu.png"  },
            new Belt { gradecode = "4_Kyu_Kari", grade = "5º/4º Kyu", image = "belt_4_Kyu_Kari.png"  },
            new Belt { gradecode = "4_Kyu", grade = "4º Kyu", image = "belt_4_Kyu.png"  },
            new Belt { gradecode = "3_Kyu_Kari", grade = "4ª/3º Kyu", image = "belt_3_Kyu_Kari.png"  },
