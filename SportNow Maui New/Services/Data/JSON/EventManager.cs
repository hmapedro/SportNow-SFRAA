...
namespace SportNow.Services.Data.JSON
{
	public class EventManager
	{
        ...
        public async Task<string> Update_Event_Participation_Numero_Acompanhantes(string competition_participationid, string numero_acompanhantes)
        {
            Debug.Print("Update_Event_Participation_Numero_Acompanhantes " + Constants.RestUrl_Update_EventParticipation_Numero_Acompanhantes + "?eventparticipationid=" + competition_participationid + "&numero_acompanhantes=" + numero_acompanhantes);
            Uri uri = new Uri(string.Format(Constants.RestUrl_Update_EventParticipation_Numero_Acompanhantes + "?eventparticipationid=" + competition_participationid + "&numero_acompanhantes=" + numero_acompanhantes, string.Empty));
            try
            {
                HttpResponseMessage response = await client.GetAsync(uri);
