...
{
	public class AttendanceMonthPageCS : DefaultPage
	{
        ...
        public void CreateClassProgramButton()
        {
            ...
            classProgramButton = new RoundButton("Programa de Treino", 100, 40);
		...
		public void CreateClassesColletion()
		{
			...
			class_attendanceCollectionView = new CollectionView
			{
				...
				EmptyView = new ContentView
				{
					Content = new Microsoft.Maui.Controls.StackLayout
					{
						Children =
							{
								new Label { Text = "Não existem Alunos inscritos nesta aula.", HorizontalTextAlignment = TextAlignment.Center, TextColor = App.normalTextColor, FontSize = 20 },
							}
					}
				}
			};
			...
			class_attendanceCollectionView.ItemTemplate = new DataTemplate(() =>
			{
				...
				itemabsoluteLayout.SetLayoutBounds(nameLabel, new Rect(0, 0, App.screenWidth - 50 * App.screenWidthAdapter, 30 * App.screenHeightAdapter));
                ...
                itemabsoluteLayout.SetLayoutBounds(attendanceStatus_Frame, new Rect(App.screenWidth - 40 * App.screenWidthAdapter, 0, 30 * App.screenWidthAdapter, 30 * App.screenHeightAdapter));

				return itemabsoluteLayout;
			});

			absoluteLayout.Add(class_attendanceCollectionView);
			absoluteLayout.SetLayoutBounds(class_attendanceCollectionView, new Rect(0, 130 * App.screenWidthAdapter, App.screenWidth, App.screenHeight - 230 * App.screenHeightAdapter));
            ...
            absoluteLayout.SetLayoutBounds(gridCount, new Rect(0, App.screenHeight - 100 * App.screenWidthAdapter, App.screenWidth, 50 * App.screenHeightAdapter));
		...
		public void CreateConfirmButton()
		{
			...
			RoundButton confirmButton = new RoundButton("CONFIRMAR PRESENÇAS", 100, 50);
			confirmButton.button.Clicked += OnConfirmButtonClicked;

			absoluteLayout.Add(confirmButton);
            absoluteLayout.SetLayoutBounds(confirmButton, new Rect(0, App.screenWidth - (60 * App.screenHeightAdapter), App.screenWidth, 50 * App.screenHeightAdapter));
		}
